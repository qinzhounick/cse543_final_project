# IDT
# python posterior_sample.py +data=ffhq_grayscale +task=IDT +model=edm_unet_adm_blackhole +sampler=pnp_edm \
...
python posterior_sample.py +data=ffhq_grayscale +task=IDT +model=edm_unet_adm_gray_ffhq +sampler=pnp_edm \
       sampler.mode=vp_sde sampler.rho=10 sampler.rho_decay_rate=0.9 sampler.rho_min=0.3 gpu=0 add_exp_name=anneal-0.9
#The original code processes grayscale images with a model and adds noise accordingly.
# python posterior_sample.py +data=ffhq_grayscale +task=coded_diffraction_patterns_grayscale +model=edm_unet_adm_blackhole +sampler=pnp_edm \
#       sampler.mode=vp_sde sampler.rho=10 sampler.rho_decay_rate=0.9 sampler.rho_min=0.3 gpu=0 add_exp_name=anneal-0.9
